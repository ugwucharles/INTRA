...
export function ContactList({ selectedId }: ContactListProps) {
  ...
  return (
    <div className="flex flex-col h-full bg-transparent">
      <div className="flex-shrink-0 px-4 pt-4 pb-3 border-b border-gray-200 intra-dashboard-surface-strong">
        ...
        <div className="relative">
          ...
          <input
            ...
            className="w-full pl-9 pr-3 py-2 text-sm bg-white/80 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-black/10 focus:bg-white focus:border-gray-300 transition-colors"
          />
        </div>

        <div
          className="mt-3 flex p-1 rounded-xl bg-white/75 ring-1 ring-inset ring-gray-200"
          role="tablist"
        ...
        {isAdmin && showAddForm && (
          <form onSubmit={handleAddContact} className="mt-3 p-3 rounded-xl bg-white/75 ring-1 ring-inset ring-gray-200 space-y-2.5">
            <Input
              label="Name"
              value={formData.name}
    ...
    <li>
      <Link
        ...
        className={`flex items-center gap-3 px-4 py-3 transition-colors ${
          isActive ? 'bg-gray-50' : 'hover:bg-white/70'
        }`}
      >
