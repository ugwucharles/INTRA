...
"[project]/frontend/src/app/dashboard/analytics/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                ...
                fileName: "[project]/frontend/src/app/dashboard/analytics/page.tsx",
                lineNumber: 71,
                columnNumber: 7
            }, this),
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
            ...
            sub && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
...
function AnalyticsPage() {
    ...
    const [range, setRange] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(7);
                ...
                "AnalyticsPage.useEffect.load": async ()=>{
                    try {
                        ...
                        const enriched = convs.map({
                            "AnalyticsPage.useEffect.load.enriched": (c)=>({
                                    ...c,
                                    customer: customers.find({
                                        "AnalyticsPage.useEffect.load.enriched": (cu)=>cu.id === c.customerId
                                    }["AnalyticsPage.useEffect.load.enriched"])
                                })
                        }["AnalyticsPage.useEffect.load.enriched"]);
    ...
    const kpis = (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "AnalyticsPage.useMemo[kpis]": ()=>{
            ...
            const open = conversations.filter({
                "AnalyticsPage.useMemo[kpis]": (c)=>c.status === 'OPEN'
            }["AnalyticsPage.useMemo[kpis]"]).length;
            const pending = conversations.filter({
                "AnalyticsPage.useMemo[kpis]": (c)=>c.status === 'PENDING'
            }["AnalyticsPage.useMemo[kpis]"]).length;
            const closed = conversations.filter({
                "AnalyticsPage.useMemo[kpis]": (c)=>c.status === 'CLOSED'
            }["AnalyticsPage.useMemo[kpis]"]).length;
            const resolutionRate = total > 0 ? Math.round(closed / total * 100) : 0;
            // Average Response Time
            const respondedConvs = conversations.filter({
                "AnalyticsPage.useMemo[kpis].respondedConvs": (c)=>c.firstResponseTime != null
            }["AnalyticsPage.useMemo[kpis].respondedConvs"]);
            let avgResponseTimeSeconds = 0;
            if (respondedConvs.length > 0) {
                const sum = respondedConvs.reduce({
                    "AnalyticsPage.useMemo[kpis].sum": (acc, c)=>acc + (c.firstResponseTime || 0)
                }["AnalyticsPage.useMemo[kpis].sum"], 0);
    ...
    // ── Volume trends ─────────────────────────────────────────────────────────
    const volumeData = (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "AnalyticsPage.useMemo[volumeData]": ()=>{
            return Array.from({
                length: range
            }, {
                "AnalyticsPage.useMemo[volumeData]": (_, i)=>{
                    const d = new Date();
                    d.setDate(d.getDate() - (range - 1 - i));
                    const count = conversations.filter({
                        "AnalyticsPage.useMemo[volumeData]": (c)=>isSameDay(new Date(c.createdAt), d)
                    }["AnalyticsPage.useMemo[volumeData]"]).length;
                    return {
    ...
    const maxVolume = (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "AnalyticsPage.useMemo[maxVolume]": ()=>Math.max(...volumeData.map({
                "AnalyticsPage.useMemo[maxVolume]": (d)=>d.count
            }["AnalyticsPage.useMemo[maxVolume]"]), 1)
    }["AnalyticsPage.useMemo[maxVolume]"], [
        volumeData
    ]);
    // ── Channel breakdown ─────────────────────────────────────────────────────
    const channelData = (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "AnalyticsPage.useMemo[channelData]": ()=>{
            const map = {};
            conversations.forEach({
                "AnalyticsPage.useMemo[channelData]": (c)=>{
            ...
            return Object.entries(map).map({
                "AnalyticsPage.useMemo[channelData]": ([source, count])=>({
                        source,
                        count,
                        pct: Math.round(count / total * 100)
                    })
            }["AnalyticsPage.useMemo[channelData]"]).sort({
                "AnalyticsPage.useMemo[channelData]": (a, b)=>b.count - a.count
            }["AnalyticsPage.useMemo[channelData]"]);
        }
    }["AnalyticsPage.useMemo[channelData]"], [
        conversations
    ...
    // ── Team performance ──────────────────────────────────────────────────────
    const agentStats = (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "AnalyticsPage.useMemo[agentStats]": ()=>{
            return staff.map({
                "AnalyticsPage.useMemo[agentStats]": (agent)=>{
                    const assigned = conversations.filter({
                        "AnalyticsPage.useMemo[agentStats].assigned": (c)=>c.assignedTo === agent.id
                    }["AnalyticsPage.useMemo[agentStats].assigned"]);
                    const closed = assigned.filter({
                        "AnalyticsPage.useMemo[agentStats]": (c)=>c.status === 'CLOSED'
                    }["AnalyticsPage.useMemo[agentStats]"]).length;
                    return {
                        agent,
                        total: assigned.length,
                        open: assigned.filter({
                            "AnalyticsPage.useMemo[agentStats]": (c)=>c.status === 'OPEN'
                        }["AnalyticsPage.useMemo[agentStats]"]).length,
                        pending: assigned.filter({
                            "AnalyticsPage.useMemo[agentStats]": (c)=>c.status === 'PENDING'
                        }["AnalyticsPage.useMemo[agentStats]"]).length,
                        closed,
                        resolutionRate: assigned.length > 0 ? Math.round(closed / assigned.length * 100) : 0
                    };
                }
            }["AnalyticsPage.useMemo[agentStats]"]).sort({
                "AnalyticsPage.useMemo[agentStats]": (a, b)=>b.total - a.total
            }["AnalyticsPage.useMemo[agentStats]"]);
        }
    }["AnalyticsPage.useMemo[agentStats]"], [
        conversations,
    ...
    const maxAgentTotal = (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "AnalyticsPage.useMemo[maxAgentTotal]": ()=>Math.max(...agentStats.map({
                "AnalyticsPage.useMemo[maxAgentTotal]": (a)=>a.total
            }["AnalyticsPage.useMemo[maxAgentTotal]"]), 1)
    }["AnalyticsPage.useMemo[maxAgentTotal]"], [
        agentStats
    ]);
    const unassignedCount = (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "AnalyticsPage.useMemo[unassignedCount]": ()=>conversations.filter({
                "AnalyticsPage.useMemo[unassignedCount]": (c)=>!c.assignedTo
            }["AnalyticsPage.useMemo[unassignedCount]"]).length
    }["AnalyticsPage.useMemo[unassignedCount]"], [
        conversations
    ]);
    if (loading) {
                    ...
                    children: [
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: [
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    children: [
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                            ...
                                            children: "All-time overview of your inbox performance"
                                        }, void 0, false, {
                                            fileName: "[project]/frontend/src/app/dashboard/analytics/page.tsx",
                                            lineNumber: 251,
                                            columnNumber: 17
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    className: "flex items-center gap-2 bg-white border border-gray-200 rounded-lg p-1",
                                    children: [
                                        7,
                                        30
                                            ...
                                            onClick: ()=>setRange(r),
                                            className: `px-3 py-1.5 text-xs font-medium rounded-md transition-all ${range === r ? 'bg-gray-900 text-white shadow-sm' : 'text-gray-500 hover:text-gray-900'}`,
                                            children: [
                                                r,
                                                "d"
                                            ]
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: [
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(KpiCard, {
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(KpiCard, {
                                    ...
                                    sub: kpis.total ? `${Math.round(kpis.open / kpis.total * 100)}% of total` : undefined
                                }, void 0, false, {
                                    fileName: "[project]/frontend/src/app/dashboard/analytics/page.tsx",
                                    lineNumber: 279,
                                    columnNumber: 15
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(KpiCard, {
                                    ...
                                    sub: kpis.total ? `${Math.round(kpis.pending / kpis.total * 100)}% of total` : undefined
                                }, void 0, false, {
                                    fileName: "[project]/frontend/src/app/dashboard/analytics/page.tsx",
                                    lineNumber: 280,
                                    columnNumber: 15
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(KpiCard, {
                                    ...
                                    value: kpis.closed,
                                    color: "text-gray-500",
                                    sub: kpis.total ? `${Math.round(kpis.closed / kpis.total * 100)}% of total` : undefined
                                }, void 0, false, {
                                    fileName: "[project]/frontend/src/app/dashboard/analytics/page.tsx",
                                    lineNumber: 281,
                                    columnNumber: 15
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(KpiCard, {
                                    label: "Avg Response",
                                    value: kpis.formattedResponseTime,
                                    color: "text-blue-600",
                                    sub: "First reply"
                                }, void 0, false, {
                                    fileName: "[project]/frontend/src/app/dashboard/analytics/page.tsx",
                            ...
                            children: [
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    children: [
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                            ...
                                            children: [
                                                "New conversations per day — last ",
                                                range,
                                                " days"
                                            ]
                                        }, void 0, true, {
                                                ...
                                                return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                    ...
                                                    children: [
                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                            ...
                                                            children: [
                                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                    className: "bg-gray-900 text-white text-xs rounded-lg px-2 py-1 whitespace-nowrap shadow-lg",
                                                                    children: [
                                                                        day.fullLabel,
                                                                        ": ",
                                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                        ...
                                                        range <= 14 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                            className: "text-[9px] text-gray-400 truncate w-full text-center",
                                                            children: day.label.split(' ')[1]
                                                        }, void 0, false, {
                                                            fileName: "[project]/frontend/src/app/dashboard/analytics/page.tsx",
                                                            lineNumber: 321,
                                                            columnNumber: 27
                                        ...
                                        range === 30 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            className: "flex justify-between mt-1",
                                            children: [
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                    className: "text-[10px] text-gray-400",
                                                    children: volumeData[0]?.label
                                                }, void 0, false, {
                                                    fileName: "[project]/frontend/src/app/dashboard/analytics/page.tsx",
                                                    lineNumber: 333,
                                                    columnNumber: 21
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    children: [
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                            className: "text-xs text-gray-400 mb-6",
                                            children: "Conversations by source channel"
                                        }, void 0, false, {
                                            fileName: "[project]/frontend/src/app/dashboard/analytics/page.tsx",
                                            lineNumber: 343,
                                            columnNumber: 17
                                        }, this),
                                        channelData.length === 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                            ...
                                            className: "space-y-4",
                                            children: channelData.map((ch)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                    children: [
                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                            ...
                                                            children: [
                                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                                    ...
                                                                    children: channelLabel(ch.source)
                                                                }, void 0, false, {
                                                                    fileName: "[project]/frontend/src/app/dashboard/analytics/page.tsx",
                                                                    lineNumber: 352,
                                                                    columnNumber: 27
                            ...
                            children: [
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    children: [
                                        ...
                                        unassignedCount > 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                            className: "text-xs font-medium px-2.5 py-1 rounded-full bg-yellow-50 text-yellow-700 border border-yellow-200",
                                            children: [
                                                unassignedCount,
                                                " unassigned"
                                            ]
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                    className: "text-xs text-gray-400 mb-6",
                                    children: "All-time stats per agent"
                                }, void 0, false, {
                                    fileName: "[project]/frontend/src/app/dashboard/analytics/page.tsx",
                                    lineNumber: 383,
                                    columnNumber: 15
                                }, this),
                                agentStats.length === 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                    className: "text-sm text-gray-400",
                                    children: "No staff data yet."
                                }, void 0, false, {
                                    fileName: "[project]/frontend/src/app/dashboard/analytics/page.tsx",
                                    lineNumber: 386,
                                    columnNumber: 17
                                    ...
                                    className: "space-y-5",
                                    children: agentStats.map((stat)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            children: [
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                    ...
                                                    children: [
                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                            ...
                                                            children: [
                                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                    className: "w-8 h-8 rounded-full bg-gray-100 flex items-center justify-center overflow-hidden flex-shrink-0",
                                                                    children: stat.agent.profilePicture ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("img", {
                                                                        src: stat.agent.profilePicture,
                                                                        alt: stat.agent.name,
                                                                        className: "w-full h-full object-cover"
                                                                    }, void 0, false, {
                                                                        fileName: "[project]/frontend/src/app/dashboard/analytics/page.tsx",
                                                                        ...
                                                                        children: stat.agent.name.charAt(0).toUpperCase()
                                                                    }, void 0, false, {
                                                                        fileName: "[project]/frontend/src/app/dashboard/analytics/page.tsx",
                                                                        lineNumber: 398,
                                                                        columnNumber: 31
                                                                ...
                                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                    children: [
                                                                        ...
                                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                                            ...
                                                                            children: stat.agent.role.toLowerCase()
                                                                        }, void 0, false, {
                                                                            fileName: "[project]/frontend/src/app/dashboard/analytics/page.tsx",
                                                                            lineNumber: 405,
                                                                            columnNumber: 29
                                                            ...
                                                            children: [
                                                                ...
                                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                    ...
                                                                    children: [
                                                                        ...
                                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                                            className: `text-sm font-bold ${stat.resolutionRate >= 70 ? 'text-green-600' : stat.resolutionRate >= 40 ? 'text-yellow-600' : 'text-red-500'}`,
                                                                            children: [
                                                                                stat.resolutionRate,
                                                                                "%"
                                                                            ]
                                                ...
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                    ...
                                                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                        ...
                                                        style: {
                                                            width: `${maxAgentTotal > 0 ? stat.total / maxAgentTotal * 100 : 0}%`
                                                        }
                                                    }, void 0, false, {
                                                        fileName: "[project]/frontend/src/app/dashboard/analytics/page.tsx",
                                                        lineNumber: 436,
...
_s(AnalyticsPage, "2qcUtnSwps48S6D5SGSUKS/tO9w=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$src$2f$contexts$2f$AuthContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuth"]
    ];
});
...
//# sourceMappingURL=frontend_src_b0ae0758._.js.map