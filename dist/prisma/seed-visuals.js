...
async function main() {
    ...
    const customer1 = await prisma.customer.create({
        data: {
            ...
            source: client_1.Channel.WHATSAPP,
        },
    });
    ...
    const conv2 = await prisma.conversation.create({
        data: {
            ...
            messages: {
                create: [
                    { senderType: client_1.SenderType.CUSTOMER, content: 'Can I change my subscription?' },
                    { senderType: client_1.SenderType.STAFF, senderId: admin.id, content: 'Yes! Just go to settings.' },
                    { senderType: client_1.SenderType.CUSTOMER, content: 'Perfect, done. Thanks!' },
                ]
            }
        },
    });
...
//# sourceMappingURL=seed-visuals.js.map