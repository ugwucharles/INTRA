...
export class ConversationsController {
  ...
  async unassignConversation(
    ...
    return this.conversationsService.unassignConversation(currentUser, id);
  }
  ...
  async setStarred(
    ...
    return this.conversationsService.setStarred(
      currentUser,
      id,
      body.isStarred,
    );
  ...
  async addConversationTag(
    ...
    return this.conversationsService.addConversationTag(
      currentUser,
      id,
      body.tagId,
    );
  ...
  async removeConversationTag(
    ...
    return this.conversationsService.removeConversationTag(
      currentUser,
      id,
      tagId,
    );
  ...
  async deleteConversation(
    ...
    return this.conversationsService.deleteConversation(currentUser, id);
  }
}
