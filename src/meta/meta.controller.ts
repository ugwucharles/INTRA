...
export class MetaController {
  ...
  verifyWebhook(
    ...
    if (!verifyToken) {
      ...
      return res.status(HttpStatus.INTERNAL_SERVER_ERROR).send('Server misconfigured');
    }
  ...
  // Delete/anonymize all data for a given customer in the current org (used for data deletion requests).
  @Post('delete-data')
